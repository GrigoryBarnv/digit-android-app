    ...
    protected fun registerMultiCamera() {
        mCameraClient = MultiCameraClient(requireContext(), object : IDeviceConnectCallBack {
            ...
            override fun onConnectDev(device: UsbDevice?, ctrlBlock: USBMonitor.UsbControlBlock?) {
                ...
                ctrlBlock ?: return
                context ?: return
                val camera = mCameraMap[device.deviceId] ?: generateCamera(requireContext(), device).also {
                    mCameraMap[device.deviceId] = it
                }
                camera.apply {
                    ...
                    mCurrentCamera?.set(currentCamera)
...
//        // Implementation to get UVC serial number
//        // This may involve using the UsbDevice#getSerialNumber method
//        // or any other method provided by the UVC library
//
//    }
    ...
    protected fun requestPermission(device: UsbDevice?) {
        ...
        serial = try {
            ...
            // Android may throw before user grants USB permission.
            device?.deviceName ?: ""
        }
    }
    ...
    protected fun setFps(int: Int) = getCurrentCamera()?.setFps(int)
