...
//            canvas?.scale(sx, sy, width / 2.0f, height / 2.0f)
    ...
    override fun setImageDrawable(drawable: Drawable?) {
        ...
        drawable?.let {
            ...
            if (isNewImageLoading || getProgress() != 0.0f) {//и§Је†іsetImageDrawableе¤љж¬ЎиЄїз”Ёжњѓй—ЄеЉЁ
